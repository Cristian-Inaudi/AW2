...
## Aplicación web con backend en Node.js + Express + MongoDB Atlas que permite gestionar:
...
- JWT → Autenticación de usuario por token.
- dotenv → Variables de entorno seguras (.env).
- Rutas protegidas para reservas (solo usuarios logueados).
